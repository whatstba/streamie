...
class AnalysisService:
    ...
    async def enqueue_analysis(self, filepath: str, priority: int = 2, 
            ...
            while self.running:
                try:
                    ...
                    try:
                        ...
                        logger.info(f"✅ Worker {worker_id} completed analysis for {task.filepath}")
        ...
        try:
            ...
            if "beat_times" in results and results["beat_times"]:
                ...
                results["structure"] = {
                    ...
                    "outro_start": beats[-128] if len(beats) > 128 else beats[-1]  # 32 bars from end
                }
    ...
    def get_queue_status(self) -> Dict:
        ...
        processing_count = sum(1 for t in self.tasks.values() 
