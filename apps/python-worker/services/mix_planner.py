...
class MixPlanner:
    ...
    async def plan_mix(self, tracks: List[Track], target_duration: float, 
                      vibe_description: str) -> Dict:
        ...
        selected_tracks = self._select_tracks_for_duration(sorted_tracks, target_duration)
    ...
    def _select_tracks_for_duration(self, tracks: List[Track], 
                                  target_duration: float) -> List[Track]:
