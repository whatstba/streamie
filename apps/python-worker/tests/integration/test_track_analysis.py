...
from tests.utils.helpers import (
    create_mock_mutagen_file,
    assert_track_analysis_valid
)
...
class TestTrackAnalysis:
    ...
    async def test_batch_analyze_tracks(self, test_client, mock_audio_files, temp_dir):
        ...
        with patch('utils.librosa.run_beat_track') as mock_beat_track:
            ...
            mock_beat_track.side_effect = [
                ...
                {"tempo": 128.0, "beats": [0, 0.469, 0.938], "beat_times": [0, 0.469, 0.938]},
                {"tempo": 140.0, "beats": [0, 0.429, 0.857], "beat_times": [0, 0.429, 0.857]}
            ]
    ...
    @pytest.mark.integration
    async def test_track_listing_with_analysis(self, test_client, mock_audio_files, temp_dir):
