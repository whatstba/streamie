...
def interpret_mood(prompt):
    ...
    mapping = {
        "afrobeats party starter": {"genre": "afrobeats", "bpm_min": 100, "bpm_max": 120, "energy": 0.7},
        "deep house afterhours": {"genre": "deep house", "bpm_min": 118, "bpm_max": 124, "energy": 0.5},
    ...
    messages=[{"role": "system", "content": "You are a music expert."},
              {"role": "user", "content": f"Given the mood '{prompt}', suggest a genre, BPM range, and energy (0-1)."}],
    max_tokens=50,
    temperature=0.5)
